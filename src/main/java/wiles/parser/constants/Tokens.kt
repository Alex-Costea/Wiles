...
object Tokens {
    ...
    @JvmField
    val STATEMENT_START_KEYWORDS = setOf(NOTHING_ID, METHOD_ID, DECLARE_ID, WHEN_ID, CASE_ID, ELSE_ID, FOR_ID,
        WHILE_ID, BREAK_ID, CONTINUE_ID, RETURN_ID, DO_ID, START_BLOCK_ID, END_BLOCK_ID)
