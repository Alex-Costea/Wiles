...
public class ExpectParamsBuilder
{
    ...
    public static ExpectParamsBuilder requestFirstToken = anyToken().removeTokenWhen(NEVER).dontIgnoreNewLine();
    ...
    public static ExpectParamsBuilder anyToken()
    {
        return new ExpectParamsBuilder((x)->true);
    }


    private final Predicate<String> foundTest;
