...
}""", "CODE_BLOCK(EXPRESSION(TYPE NOTHING; !TYPE STRING!write; METHOD|APPLY|METHOD_CALL; METHOD_CALL(TYPE METHOD_CALL; (METHOD_CALL(EXPRESSION(!elem; ASSIGN; EXPRESSION(TYPE STRING; !TYPE ANYTHING!as_text; METHOD|APPLY|METHOD_CALL; METHOD_CALL(TYPE METHOD_CALL; (METHOD_CALL(EXPRESSION(!elem; ASSIGN; EXPRESSION(TYPE INT64; #2))))))))))))")
    }
