...
class SyntaxTreeConverterTests {
    ...
    fun methodTest() {
        ...
        assertResults(null,"CODE_BLOCK(DECLARATION(!main; METHOD(TYPE NOTHING; PARAMETER ANON(!arg1; TYPE INT32); CODE_BLOCK)))",
            DECLARE_ID, "!main", ASSIGN_ID, METHOD_ID, ROUND_BRACKET_START_ID, "!arg1", TYPEOF_ID, "!int", ROUND_BRACKET_END_ID, DO_ID, NOTHING_ID)
        assertResults(null,"CODE_BLOCK(DECLARATION(!a; METHOD(TYPE NOTHING; CODE_BLOCK(DECLARATION(!b; METHOD(TYPE NOTHING; CODE_BLOCK))))))",
