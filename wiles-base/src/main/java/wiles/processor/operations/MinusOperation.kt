...
class MinusOperation(left: Value?, right: Value, context: InterpreterContext) : AbstractOperation(left, right, context) {
    override fun calculateObject() : Any?
    {
        return when{
            ...
            leftObj is WilesInfinity && rightObj is WilesInfinity -> throw ArithmeticException()
            leftObj is WilesMinusInfinity && rightObj is WilesMinusInfinity -> throw ArithmeticException()
            ...
            rightObj is WilesMinusInfinity -> WilesInfinity
            else -> null
        }
    }
    ...
    override fun calculateType(): AbstractType {
        return when {
            ...
            isSuperType(MINUS_INFINITY_TYPE, rightType) -> INFINITY_TYPE
