...
class InferFromIf(details: InferrerDetails) : InferFromStatement(details) {
    override fun infer() {
        ...
        while(components.isNotEmpty())
        {
            ...
            InferrerService(InferrerDetails(condition, variables.copy(), exceptions, context)).infer()
            ...
            InferFromCodeBlock(InferrerDetails(block, newVars, exceptions, context)).infer()
